...
//           <span className="mobileFilterIcon">&#8645;</span> 
//         </button>
//       </div>
      ...
      : products.filter((product) =>
          priceRanges.some(
            (range) =>
              ...
              product.newprice >= range.min &&
              product.newprice < range.max
          )
        );
    ...
    <>
      ...
      <div className="filterSection">
        ...
        {priceRanges.map((range) => (
          <label className="checkboxItem" key={range.label}>
            <input
              type="checkbox"
  ...
  return (
    <div className="productPage">
      ...
      <div className="productsPageMain">
        ...
        <div className="productsPageMainRight">
          <div className="productsPageMainRightTopBanner">
            1-{filteredProducts.length} of results for{" "}
